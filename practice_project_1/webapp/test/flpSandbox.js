		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail",
									"targetURL": "#compracticeproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compracticeproject1-display": {
								"semanticObject": "compracticeproject1",
								"action": "display",
								"description": "Maste r Detail",
								"title": "Master Detail",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.practiceproject1",
									"url": sap.ui.require.toUrl("com/practiceproject1")
								}
							}
						}
					}
